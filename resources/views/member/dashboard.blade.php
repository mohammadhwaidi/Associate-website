...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('member.dashboard') }}">
            ...
            <div class="sidebar-brand-text mx-3">Welcome Member</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePosts" class="collapse" aria-labelledby="headingPosts" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('member.posts.index') }}">Show All</a>
                    <a class="collapse-item" href="{{ route('member.posts.create') }}">Create New</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTestimonials" class="collapse" aria-labelledby="headingTestimonials"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('member.testimonials.index') }}">Show All</a>
                    <a class="collapse-item" href="{{ route('member.testimonials.create') }}">Create New</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseActivities" class="collapse" aria-labelledby="headingActivities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('member.activities.index') }}">Show All</a>
                    <a class="collapse-item" href="{{ route('member.activities.create') }}">Create New</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseSlideshows" class="collapse" aria-labelledby="headingSlideshows"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('member.slideshows.index') }}">Show All</a>
                    <a class="collapse-item" href="{{ route('member.slideshows.create') }}">Create New</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseEvents" class="collapse" aria-labelledby="headingEvents"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('member.events.index') }}">Show All</a>
                    <a class="collapse-item" href="{{ route('member.events.create') }}">Create New</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseInternships" class="collapse" aria-labelledby="headingInternships"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('member.internships.index') }}">Show All</a>
                    <a class="collapse-item" href="{{ route('member.internships.create') }}">Create New</a>
                </div>
            </div>
        </li>
