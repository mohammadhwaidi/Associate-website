...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('admin.internships.create') }}" class="btn btn-primary mb-3">Create New Internship</a>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('admin.internships.show', ['id' => $internship->id]) }}" class="btn btn-info">Show</a>
                            <a href="{{ route('admin.internships.show_enrollments', ['id' => $internship->id]) }}" class="btn btn-info mt-2">Show Enrollments</a>
                        </div>
                    </div>
                </div>
            @endforeach
